...
public class InvalidateTokenRequest {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof InvalidateTokenRequest)) return false;
        final InvalidateTokenRequest other = (InvalidateTokenRequest) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof InvalidateTokenRequest;
    }
    ...
    public String toString() {
        return "InvalidateTokenRequest(refreshToken=" + this.getRefreshToken() + ")";
    }
}
